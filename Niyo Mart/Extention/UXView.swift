...
extension UIView{
    ...
    func setCorneredElevation(shadow With : Int = 2 , corner radius : Int = 20 , color : UIColor = UIColor.primaryColor , clipstobound clipstobound : YesNoType = .no){
        self.layer.masksToBounds = false
...
extension UIView{
    func registerView<T : UIView>(_ T : UIView , withId id : viewID , postion : Int) -> T{
        return UINib(nibName: id.rawValue, bundle: nil).instantiate(withOwner: nil, options: nil)[postion] as! T
    }
}
class SZView : UIView{
